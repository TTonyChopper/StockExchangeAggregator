...
public class Meta {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("currency", currency).append("symbol", symbol).append("exchangeName", exchangeName).append("instrumentType", instrumentType).append("firstTradeDate", firstTradeDate).append("gmtoffset", gmtoffset).append("timezone", timezone).append("exchangeTimezoneName", exchangeTimezoneName).append("chartPreviousClose", chartPreviousClose).append("previousClose", previousClose).append("scale", scale).append("currentTradingPeriod", currentTradingPeriod).append("tradingPeriods", tradingPeriods).append("dataGranularity", dataGranularity).append("validRanges", validRanges).append("additionalProperties", additionalProperties).toString();
    }
