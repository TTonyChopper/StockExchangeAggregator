...
@JsonPropertyOrder({ "low", "close", "open", "volume", "high" })
public class Quote {
	...
	public String toString() {
		return new ToStringBuilder(this).append("low", low).append("close", close).append("open", open)
				.append("volume", volume).append("high", high).append("additionalProperties", additionalProperties)
				.toString();
	}
